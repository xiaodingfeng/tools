<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="prompts" prop="systemPrompts" />
      ...
      <el-table-column :show-overflow-tooltip="true" align="center" label="图标">
        <template slot-scope="scope">
          <el-link :href="scope.row.ico" target="_blank" type="primary">{{ scope.row.ico }}</el-link>
        </template>
      </el-table-column>
    </el-table>
...
import { remove, get, page, update, add } from '@/api/chat/model'
