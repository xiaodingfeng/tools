...
import org.xiaobai.ai.api.storage.ChatMessageStorage;
import org.xiaobai.ai.api.storage.DataStorage;
...
public class ParsedEventSourceListener extends EventSourceListener {
     ...
     * 问题聊天记录
     */
    private final ChatMessageVO questionChatMessageVO;
    /**
     * 回答聊天记录
     */
    private final ChatMessageVO answerChatMessageVO;
    /**
     * 已经接收到的完整消息
     */
    ...
    private ParsedEventSourceListener(Builder builder) {
        ...
        this.questionChatMessageVO = builder.chatMessageVO;
        this.answerChatMessageVO = new ChatMessageVO();
    }
    ...
    public void onEvent(@NotNull EventSource eventSource, String id, String type, @NotNull String originalData) {
        ...
        if (isEnd) {
            ...
            dataStorage.onComplete(ChatMessageStorage.builder()
                    .questionChatMessageVO(questionChatMessageVO)
                    .answerChatMessageVO(answerChatMessageVO)
            ...
            // 设置已经接收到消息内容
            answerChatMessageVO.setContent(receivedMessage);
            ...
            chatReplyMessageVO.setId(answerChatMessageVO.getMessageId());
            chatReplyMessageVO.setRole(null);
            chatReplyMessageVO.setParentMessageId(answerChatMessageVO.getParentMessageId());
            chatReplyMessageVO.setConversationId(answerChatMessageVO.getConversationId());
    ...
    public void onFailure(@NotNull EventSource eventSource, @Nullable Throwable t, @Nullable Response response) {
        ...
        // 遍历监听器发送异常消息
        for (AbstractStreamListener listener : listeners) {
            listener.onError(receivedMessage, t,responseStr, response);
        }
    }
    ...
    public static class Builder {
        ...
        public Builder setChatMessageVO(ChatMessageVO chatMessageVO) {
